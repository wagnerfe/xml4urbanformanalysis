...
from ufo_map.Feature_engineering.buildings_v2 import features_buildings_distance_based
...
# path output
path_out_buildings = '/data/metab/urbanformvmt/data/output/' + 'berlin_trips_building_bld_dist_ft_part_' + part + '.csv'
