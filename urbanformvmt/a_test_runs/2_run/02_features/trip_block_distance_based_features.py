...
from ufo_map.Feature_engineering.blocks import features_blocks_distance_based
...
# path output
path_out = '/p/projects/vwproject/felix_files/data/output/' + 'berlin_trips_block_dist_ft_part_' + part + '.csv'
